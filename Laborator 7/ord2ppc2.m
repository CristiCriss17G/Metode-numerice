...
yc3 = [y10, y20];
k0 = h * ord2a(tc, yc3);
k1 = h * ord2a(tc+h/2, yc3+k0/2);
k2 = h * ord2a(tc+h, yc3+2*k1-k0);
yc2 = yc3 + h * (k0 + 4 * k1 + k2) / 6;
tc = tc + h;
k0 = h * ord2a(tc, yc2);
k1 = h * ord2a(tc+h/2, yc2+k0/2);
k2 = h * ord2a(tc+h, yc2+2*k1-k0);
yc1 = yc2 + h * (k0 + 4 * k1 + k2) / 6;
tc = tc + h;
for i = 3:q / h
    yca = yc1 + h * (23 * ord2a(tc, yc1) - 16 * ord2a(tc-h, yc2) ...
        +5 * ord2a(tc-2*h, yc3)) / 12;
    yc = yc1 + h * (5 * ord2a(tc+h, yca) ...
